...
def create_parser():
    ...
    parser.add_argument('--ex_name', default='weather', type=str)
    ...
    parser.add_argument('--dataname', default='sevir', choices=['mmnist', 'taxibj', 'caltech', 'sevir', 'ns2d', 'taxibj12-12', 'weather'])
    parser.add_argument('--num_workers', default=8, type=int)

    # model parameters
    parser.add_argument('--in_shape', default=[10, 1, 128, 128], type=int,nargs='*') #  [10, 2, 128, 128] for weather
